...
def run_assistant(
    ...
    while True:
        ...
        turn_cost = estimate_cost(user_msg, reply, OPENAI_MODEL)
...
if __name__ == "__main__":
    ...
    stats = run_assistant(
        persona="Bạn là trợ giảng cho khóa học về AI, "
                "luôn trả lời bằng tiếng Việt khi không có yêu cầu gì khác. "
                "Trả lời rõ ràng, nếu không chắc chắn về thông tin thì nói rõ ra thay vì bịa thông tin."
    )
    print("\n--- Thống kê phiên chat ---")
